    ...
    <div className="page" style={{ background:'var(--bg)' }}>
      ...
      <div style={{ padding:'56px 24px 24px', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', position:'relative' }}>
          <div style={{ animation: ready ? 'fadeInUp 0.4s ease both' : 'none' }}>
      ...
      {todayEvents.length > 0 && (
        <div style={{ margin:'0 16px 20px', animation: ready ? 'fadeInUp 0.4s 0.05s ease both' : 'none', opacity: ready ? 1 : 0 }}>
          {todayEvents.map(ev => (
      ...
      {itemsOut > 0 && (
        <div style={{ margin:'0 16px 20px', animation: ready ? 'fadeInUp 0.4s 0.08s ease both' : 'none', opacity: ready ? 1 : 0 }}>
      ...
      {/* ── Quick actions ── */}
      <div style={{ padding:'0 16px 24px', animation: ready ? 'fadeInUp 0.4s 0.1s ease both' : 'none', opacity: ready ? 1 : 0 }}>
      ...
      {/* ── Prossimi eventi ── */}
      {upcoming.length > 0 && (
        <div style={{ padding:'0 16px 8px', animation: ready ? 'fadeInUp 0.4s 0.15s ease both' : 'none', opacity: ready ? 1 : 0 }}>
