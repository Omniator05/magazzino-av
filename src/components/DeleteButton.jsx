export default function DeleteButton({ onClick, size = 36, ariaLabel }) {
  return (
    <button onClick={onClick} className="delete-btn" aria-label={ariaLabel} style={{ width:size, height:size }}>
