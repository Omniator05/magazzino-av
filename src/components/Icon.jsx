...
export const Image = ({ size }) => (
  <svg {...base(size)}><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L5 22"/></svg>
)
export const CreditCard = ({ size }) => (
  <svg {...base(size)}><rect width="20" height="14" x="2" y="5" rx="2"/><path d="M2 10h20"/></svg>
)
