 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uf(r){var e,t;if(U(r instanceof Y||r instanceof ne),r instanceof Y){if(r instanceof Ad){const i=((t=(e=r.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(s=>Y.create(r.field,"==",s)))||[];return ne.create(i,"or")}return r}const n=r.filters.map(i=>uf(i));return ne.create(n,r.op)}function Wy(r){if(r.getFilters().length===0)return[];const e=Aa(uf(r));return U(lf(e)),Ta(e)||wa(e)?[e]:e.getFilters()}function Ta(r){return r instanceof Y}function wa(r){return r instanceof ne&&qa(r)}function lf(r){return Ta(r)||wa(r)||function(t){if(t instanceof ne&&ma(t)){for(const n of t.getFilters())if(!Ta(n)&&!wa(n))return!1;return!0}return!1}(r)}function Aa(r){if(U(r instanceof Y||r instanceof ne),r instanceof Y)return r;if(r.filters.length===1)return Aa(r.filters[0]);const e=r.filters.map(n=>Aa(n));let t=ne.create(e,r.op);return t=Ms(t),lf(t)?t:(U(t instanceof ne),U(nr(t)),U(t.filters.length>1),t.filters.reduce((n,i)=>Xa(n,i)))}function Xa(r,e){let t;return U(r instanceof Y||r instanceof ne),U(e instanceof Y||e instanceof ne),t=r instanceof Y?e instanceof Y?function(i,s){return ne.create([i,s],"and")}(r,e):Ll(r,e):e instanceof Y?Ll(e,r):function(i,s){if(U(i.filters.length>0&&s.filters.length>0),nr(i)&&nr(s))return Ed(i,s.getFilters());const o=ma(i)?i:s,c=ma(i)?s:i,u=o.filters.map(h=>Xa(h,c));return ne.create(u,"or")}(r,e),Ms(t)}function Ll(r,e){if(nr(e))return Ed(e,r.getFilters());{const t=e.filters.map(n=>Xa(r,n));return ne.create(t,"or")}}function Ms(r){if(U(r instanceof Y||r instanceof ne),r instanceof Y)return r;const e=r.getFilters();if(e.length===1)return Ms(e[0]);if(Id(r))return r;const t=e.map(i=>Ms(i)),n=[];return t.forEach(i=>{i instanceof Y?n.push(i):i instanceof ne&&(i.op===r.op?n.push(...i.filters):n.push(i))}),n.length===1?n[0]:ne.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ym{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Cn(e)}set(e,t,n){this._verifyNotCommitted();const i=Ct(e,this._firestore),s=yo(i.converter,t,n),o=mo(this._dataReader,"WriteBatch.set",i._key,s,i.converter!==null,n);return this._mutations.push(o.toMutation(i._key,he.none())),this}update(e,t,n,...i){this._verifyNotCommitted();const s=Ct(e,this._firestore);let o;return o=typeof(t=te(t))=="string"||t instanceof Zt?Vc(this._dataReader,"WriteBatch.update",s._key,t,n,i):Cc(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(o.toMutation(s._key,he.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=Ct(e,this._firestore);return this._mutations=this._mutations.concat(new yr(t._key,he.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new D(S.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function Ct(r,e){if((r=te(r)).firestore!==e)throw new D(S.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Im extends class{constructor(t,n){this._firestore=t,this._transaction=n,this._dataReader=Cn(t)}get(t){const n=Ct(t,this._firestore),i=new aE(this._firestore);return this._transaction.lookup([n._key]).then(s=>{if(!s||s.length!==1)return L();const o=s[0];if(o.isFoundDocument())return new Ii(this._firestore,i,o.key,o,n.converter);if(o.isNoDocument())return new Ii(this._firestore,i,n._key,null,n.converter);throw L()})}set(t,n,i){const s=Ct(t,this._firestore),o=yo(s.converter,n,i),c=mo(this._dataReader,"Transaction.set",s._key,o,s.converter!==null,i);return this._transaction.set(s._key,c),this}update(t,n,i,...s){const o=Ct(t,this._firestore);let c;return c=typeof(n=te(n))=="string"||n instanceof Zt?Vc(this._dataReader,"Transaction.update",o._key,n,i,s):Cc(this._dataReader,"Transaction.update",o._key,n),this._transaction.update(o._key,c),this}delete(t){const n=Ct(t,this._firestore);return this._transaction.delete(n._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=Ct(e,this._firestore),n=new tn(this._firestore);return super.get(e).then(i=>new Rn(this._firestore,n,t._key,i._document,new Ot(!1,!1),t.converter))}}function UE(r,e,t){r=Q(r,ie);const n=Object.assign(Object.assign({},FE),t);return function(s){if(s.maxAttempts<1)throw new D(S.INVALID_ARGUMENT,"Max attempts must be at least 1")}(n),function(s,o,c){const u=new Ae;return s.asyncQueue.enqueueAndForget(async()=>{const h=await Kf(s);new gv(s.asyncQueue,h,c,o,u).au()}),u.promise}(fe(r),i=>e(new Im(r,i)),n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $m(r,e,t=!1){if(Qe(r.app))return Promise.reject(ut(r));const n="signIn",i=await zm(r,n,e),s=await Pn._fromIdTokenResponse(r,n,i);return t||await r._updateCurrentUser(s.user),s}async function HT(r,e){return $m(kn(r),e)}async function pA(r,e){return Gm(te(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Km(r){const e=kn(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function gA(r,e,t){if(Qe(r.app))return Promise.reject(ut(r));const n=kn(r),o=await ka(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",WT).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&Km(r),u}),c=await Pn._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(c.user),c}function _A(r,e,t){return Qe(r.app)?Promise.reject(ut(r)):HT(te(r),Sr.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Km(r),n})}function yA(r,e){return JT(te(r),null,e)}async function JT(r,e,t){const{auth:n}=r,s={idToken:await r.getIdToken(),returnSecureToken:!0};t&&(s.password=t);const o=await fr(r,UT(n,s));await r._updateTokensIfNecessary(o,!0)}function YT(r,e,t,n){return te(r).onIdTokenChanged(e,t,n)}function XT(r,e,t){return te(r).beforeAuthStateChanged(e,t)}function IA(r,e,t,n){return te(r).onAuthStateChanged(e,t,n)}function vA(r){return te(r).signOut()}async function EA(r){return te(r).delete()}const Ws="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oA=5*60,aA=Fh("authIdTokenMaxAge")||oA;let kh=null;const cA=r=>async e=>{const t=e&&await e.getIdTokenResult(),n=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>aA)return;const i=t==null?void 0:t.token;kh!==i&&(kh=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function TA(r=zh()){const e=wi(r,"auth");if(e.isInitialized())return e.getImmediate();const t=xT(r,{popupRedirectResolver:nA,persistence:[fw,tw,Jm]}),n=Fh("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(n,location.origin);if(location.origin===s.origin){const o=cA(s.toString());XT(t,o,()=>o(t.currentUser)),YT(t,c=>o(c))}}const i=Mh("auth");return i&&MT(t,`http://${i}`),t}function uA(){var r,e;return(e=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&e!==void 0?e:document}ST({loadJS(r){return new Promise((e,t)=>{const n=document.createElement("script");n.setAttribute("src",r),n.onload=e,n.onerror=i=>{const s=Ze("internal-error");s.customData=i,t(s)},n.type="text/javascript",n.charset="UTF-8",uA().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});sA("Browser");export{pA as A,eE as B,_n as C,TE as D,Sr as E,mt as F,KE as G,bE as H,tE as I,iE as J,GE as K,mA as L,mr as S,de as T,Yn as _,wi as a,$p as b,zh as c,Wp as d,xv as e,TA as f,te as g,mE as h,a_ as i,Zf as j,_E as k,Cv as l,AE as m,_A as n,IA as o,yA as p,Jv as q,Ft as r,vA as s,gA as t,EE as u,EA as v,Yv as w,wE as x,qE as y,vE as z};
